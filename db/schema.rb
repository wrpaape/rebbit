...
ActiveRecord::Schema.define(version: 20150611201927) do
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.string   "body"
    t.integer  "user_id"
    t.integer  "subrebbit_id"
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
  end

  add_index "posts", ["subrebbit_id"], name: "index_posts_on_subrebbit_id", using: :btree
  add_index "posts", ["user_id"], name: "index_posts_on_user_id", using: :btree

  create_table "subrebbits", force: :cascade do |t|
    t.string   "category"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  add_foreign_key "posts", "subrebbits"
